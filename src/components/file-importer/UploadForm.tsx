...
export function UploadForm({ onUploadSuccess, onUploadError }: UploadFormProps) {
  ...
  return (
    <div className="rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark dark:shadow-card sm:p-8">
      ...
      {/* Instructions */}
      <div className="mb-6 rounded-lg border border-stroke bg-gray-2/50 p-4 dark:border-dark-3 dark:bg-dark-2/50">
        <div className="mb-3 flex items-start gap-2">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-body-color dark:text-dark-6">
              فایل شما باید شامل فیلدهای زیر باشد:
            </p>
          </div>
        </div>
        ...
        <div className="mr-7 space-y-2">
          <div className="flex items-start gap-2">
            <span className="mt-1.5 inline-block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
            <div className="text-sm">
              <code className="rounded bg-gray-2 px-2 py-0.5 font-mono text-xs text-dark dark:bg-dark dark:text-white">
                field_1
              </code>
              <span className="mr-2 text-body-color dark:text-dark-6">
                - توضیح فیلد اول (الزامی)
              </span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm">
              ...
              <span className="mr-2 text-body-color dark:text-dark-6">
                - توضیح فیلد دوم (الزامی)
              </span>
            </div>
          </div>

          <div className="flex items-start gap-2">
            <span className="mt-1.5 inline-block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-body-color"></span>
            <div className="text-sm">
              <code className="rounded bg-gray-2 px-2 py-0.5 font-mono text-xs text-dark dark:bg-dark dark:text-white">
                field_3
              </code>
              <span className="mr-2 text-body-color dark:text-dark-6">
                - توضیح فیلد سوم (اختیاری)
              </span>
            </div>
          </div>
        </div>

        <div className="mr-7 mt-3 pt-3 border-t border-stroke dark:border-dark-3">
          <button
            type="button"
