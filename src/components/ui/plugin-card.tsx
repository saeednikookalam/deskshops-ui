        ...
        >
            ...
            <div className="flex items-center gap-3 mb-3">
                <div className="flex-shrink-0">
                    {logoUrl && !imageError ? (
                        <div
                            className="w-10 h-10 rounded-full overflow-hidden bg-gray-2 dark:bg-dark-2 flex items-center justify-center">
                            <Image
                                src={logoUrl}
                                alt={name}
                                width={40}
            ...
            <div className="mb-3 flex items-center">
                {hasSubscription ? (
                    ...
                    <div
                        className="w-full p-3 bg-yellow-light-4 dark:bg-yellow-dark/10 rounded-lg border border-yellow-dark/20">
