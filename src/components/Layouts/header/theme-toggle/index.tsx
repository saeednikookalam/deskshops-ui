  ...
  return (
    ...
    >
      ...
      <span aria-hidden className="relative flex gap-2.5">
        {/* Indicator */}
        <span className="absolute size-[38px] rounded-full border border-gray-200 bg-white transition-all dark:ltr:translate-x-[48px] dark:rtl:-translate-x-[48px] dark:border-none dark:bg-dark-2 dark:group-hover:bg-dark-3" />
