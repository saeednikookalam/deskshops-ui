...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "max-w-[260px] overflow-hidden border-r border-gray-200 bg-white transition-[width] duration-200 ease-linear dark:border-gray-800 dark:bg-gray-dark",
      ...
      >
        <div className="flex h-full flex-col py-10 pl-[25px] pr-[7px]">
          <div className="relative pr-4.5 mb-6">
            <div className="text-2xl font-bold text-dark dark:text-white text-center">
